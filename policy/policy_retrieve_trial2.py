...
def policy(current_state, a_h):
    ...
    if current_state[0][0] in goal_set and is_hightrust_tuple(fy):
...
# #------------------main------------------------
# current_state = (('H3', (0.14285714285714285,0.14285714285714285,0.14285714285714285,0.14285714285714285,0.14285714285714285,0.14285714285714285,0.14285714285714285), ('t',)), frozenset(), 1)
# a_h = tuple('s')
# while current_state[2] < 6:
