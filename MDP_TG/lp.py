    ...
    for init_node in prod_mdp.graph['initial']:
        ...
        try:
            ...
            for s in Sr:
                ...
                f_plan_prefix_act.write(' '.join(str(int(x[0])) for x in U)+ '\n')               
                f_plan_prefix_prob.write(' '.join(str(x) for x in P)+ '\n')
    ...
    for init_node in prod_mdp.graph['initial']:
        ...
        try:
            ...
            for s in Sn:
                ...
                f_plan_suffix_act.write(' '.join(str(int(x[0])) for x in U)+ '\n')               
                f_plan_suffix_prob.write(' '.join(str(x) for x in P)+ '\n')
...
def syn_plan_bad(prod_mdp, state_types):
    ...
    for sd in Sd:
        ...
        f_plan_bad_act.write(' '.join(str(int(x[0])) for x in U)+ '\n')               
        f_plan_bad_prob.write(' '.join(str(x) for x in P)+ '\n')
    return plan_bad
